...
- Lead Import: /lead-import (sub-pages: CSV Import, Import History at /lead-import/history, Meta & Zapier Leads at /lead-import/meta-leads, Aliice Calls at /lead-import/retell-calls, Embed Forms at /lead-import/embed-forms)
...
- AI Agents: /agents
- Marketing: /marketing (sub: New Campaign at /marketing/campaigns)
- Controllers: /controllers
- Email Reports: /email-reports
- Statistics: /statistics
- Chat with Aliice: /chat (sub: Chat Logs at /chatlogs)
- Client Onboarding: /client-onboarding
- Invoice Linker: /invoice-linker
- Settings: /settings (sub: Online Booking at /settings/online-booking)
- Knowledgebase: /knowledgebase
- 3D Patient View: /patients/[id]/3d
- Search: /search
`;
...
function shouldTriggerAssist(query: string): boolean {
  ...
  const prefixes = ["how", "where", "can i", "what is", "what are", "why", "should i", "tell me about", "explain", "help"];
