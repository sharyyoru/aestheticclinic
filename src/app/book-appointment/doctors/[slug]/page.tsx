    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/book-appointment/doctors" className="text-emerald-600 hover:underline">
            Back to Doctors
          </Link>
        </div>
      </main>
          ...
          <div className="lg:sticky lg:top-8 h-fit">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-100">
              ...
              <div className="p-5">
                ...
                <p className="text-sm text-emerald-600 font-medium mb-3">{doctor.specialty}</p>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all"
                      placeholder="John"
                    />
                  </div>
                  <div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {SERVICE_OPTIONS.map((service) => (
                    ...
                    >
                      <span className={`font-medium ${selectedService === service ? "text-emerald-700" : "text-slate-900"}`}>
                        {service}
                      </span>
                    </button>
                  ))}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all resize-none"
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 bg-emerald-600 text-white py-3 rounded-xl font-medium hover:bg-emerald-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
