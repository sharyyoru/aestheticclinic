    ...
    async function loadPatientDetails() {
      try {
        ...
        const patientInsurance =
          ...
          patientInsurances[0] ||
          null;
        const street = data.street_address || '';
        const streetNo = '';
        const zip = data.postal_code || '';
        const city = data.town || '';
              ...
              {!selectedFile || selectedFile.kind !== "file" ? (
                ...
                <div className="flex w-full flex-col gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 rounded-full bg-sky-500 px-3 py-1.5 text-[11px] font-semibold text-white shadow hover:bg-sky-600 disabled:opacity-60"
                  >
                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
