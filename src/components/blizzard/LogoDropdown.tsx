...
const NAV_SECTIONS: { items: NavItem[] }[] = [
  ...
  },
  {
    items: [
      ...
      { label: "Documentation", href: "/documentation", icon: <MultiPathNavIcon paths={["M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z", "M14 2v6h6", "M9 13h6M9 17h4"]} /> },
    ],
  },
];
