...
const LOADER_HIDDEN_ROUTES = ["/embed", "/aliicechat/embed", "/aliicechatembed"];
...
export default function GlobalLoader() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/80 dark:bg-[#141820]/80 backdrop-blur-sm">
