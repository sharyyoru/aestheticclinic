...
const STANDALONE_ROUTES = ["/login", "/demo", "/book-appointment", "/intake", "/onboarding", "/invoice/pay", "/consultations", "/embed", "/form", "/aliicechat", "/aliicechatembed", "/pricing", "/pricingaliice", "/appx", "/prodapp", "/patientapp", "/aliicestory", "/documentation"];
