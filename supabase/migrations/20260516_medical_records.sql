...
CREATE TABLE IF NOT EXISTS medical_records (
  ...
  -- Original file references (for backup/reference - DO NOT DELETE ORIGINAL PDFs)
...
COMMENT ON TABLE medical_records IS 'Stores editable medical record content (AP, AF, Notes) for each patient with autosave support. Original PDF files are preserved in storage as backup.';
